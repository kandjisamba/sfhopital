 ...
 */
final class Version20191128101820 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE medcin (id INT AUTO_INCREMENT NOT NULL, service_id INT NOT NULL, matricule VARCHAR(8) NOT NULL, INDEX IDX_B49ACC86ED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
